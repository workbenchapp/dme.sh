...
import { Card, CardGroup, Col, Container, Figure, Row } from "react-bootstrap";
import { StaticImage } from "gatsby-plugin-image";

import Avatar from "react-avatar";

import SellComputeImage from "../images/we-will-sell-compute.png";
import ShareComputeImage from "../images/we-will-share-compute.png";

const DaonetesIndexPage = () => {
  return (
    <Container>
      <h1>DAOnetes</h1>
      ...
      <div className="wallOfText">
        ...
        <Row>
          ...
          <Col>
            <Figure className="glass">
              <img src={SellComputeImage} height={360} />
              <Figure.Caption>
      ...
      <div className="wallOfText">
        ...
        <Row>
          ...
          <Col>
            <Figure className="glass">
              <img src={ShareComputeImage} height={360} />
              <Figure.Caption>
...
export default DaonetesIndexPage;
